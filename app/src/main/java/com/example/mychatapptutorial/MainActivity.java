...
public class MainActivity extends AppCompatActivity {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final String otp = otpService.generateOtp(phonenumber);
    ...
    private void navigateToOtpScreen(String otp) {
        Intent intent = new Intent(MainActivity.this, OtpService.class);
